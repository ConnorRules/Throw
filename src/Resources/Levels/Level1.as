package Resources.Levels
{
	...
	{
		[Embed(source = "../Maps/mapCSV_Group1_Map1.csv", mimeType = "application/octet-stream")] public var mapCSV:Class;
		[Embed(source = "../Images/tiles.png")] public var mapTilesPNG:Class;
		[Embed(source = "../Maps/mapCSV_Group1_Map2.csv", mimeType = "application/octet-stream")] public var throwablesCSV:Class;
		[Embed(source = "../Images/mariotiles.png")] public var throwablesPNG:Class;
		[Embed(source = "../Maps/mapCSV_Group1_Map3.csv", mimeType = "application/octet-stream")] public var enemyCSV:Class;
		...
		private function parseEnemies():void
		{
			...
			for (var ty:int = 0; ty < enemyMap.heightInTiles; ty++)
			{
				for (var tx:int = 0; tx < enemyMap.widthInTiles; tx++)
				{
					...
					else if (enemyMap.getTile(tx, ty) == 3)
					{
						Registry.levelExit = new FlxPoint(tx * 16, ty * 16);
					}
